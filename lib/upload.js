...
exports.uploadWXWithFilePathWithToken = function (options, callback) {
    if (options.auth == null || options.auth.corpID == null || options.auth.token == null) {
        return callback("corpID or token can't be null when upload media!");
    }
    ...
    request.post({
        ...
        if (response.statusCode == 200 && body != null) {
            ...
            if (errcode == 40014) {
                wxToken.removeTokenCache(options.auth.corpID);
    ...
    async.retry(retryRule, function (parentcb) {
        async.waterfall([
            ...
            function (asyncCallback) {
                ...
                var accessToken = wxToken.getTokenCache(options.auth.corpID);
                if (accessToken != null) {
...
exports.autoDownloadAndPushToWechat = function (options, callback) {
     ...
     */
    else if (options.auth.corpID != null && options.auth.token != null) {
        autoUpload = function (results, cb) {
            exports.uploadWXWithFilePathWithToken(options, function (error, media_id) {
                if (media_id != null) {
                    results.media_id = media_id;
